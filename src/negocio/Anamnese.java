...
public class Anamnese {
    ...
    private String hipotese_diagnostica;
    ...
    public int getIdAnamnense() {
        return idAnamnense;
    }

    public void setIdAnamnense(int idAnamnense) {
        this.idAnamnense = idAnamnense;
    }
