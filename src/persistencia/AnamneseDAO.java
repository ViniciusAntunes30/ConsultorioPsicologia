...
String sql = "insert into anamnese"+
        "(queixas, sintomas, tratamentos_anteriores, medicamentos, infancia, rotina, vicios, hobbies, trabalho, historico_familiar, comportamento, linguagem, humor, hipotese_diagnostica, observacoes, numero_sessoes, valor_sessao, perioridade)"+
        "values(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, now())";
        ...
        try {
            ...
            stmt.setString(10,anamnese.getLinguagem());
            ...
            stmt.setFloat(17,anamnese.getValor_sessao());
